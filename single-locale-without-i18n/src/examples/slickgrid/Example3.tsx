    ...
    <div id="demo-container" className="container-fluid">
      <h2>
        ...
        <span className="float-end font18">
          ...
          <a
            target="_blank"
            href="https://github.com/ghiscoding/slickgrid-react-demos/tree/main/single-locale-without-i18n/src/examples/slickgrid/Example3.tsx"
          >
      ...
      <SlickgridReact gridId="grid3-2" columns={columnDefinitions2} options={gridOptions2!} dataset={dataset2} />
    </div>
  );
};
