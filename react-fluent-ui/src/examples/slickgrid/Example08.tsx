...
const Example08: React.FC = () => {
  ...
  function groupByTaxable() {
    ...
    reactGridRef.current?.dataView?.setGrouping({
      getter: 'taxable',
      formatter: (g) =>
        `Taxable: <span class="fi ${g.value ? checkIcon : uncheckIcon} text-info"></span> <span class="text-primary">(${g.count} items)</span>`,
  ...
  return !gridOptions ? (
    ...
    <div id="demo-container" className="container-fluid">
      <h2>Example 8: Excel Export Formulas</h2>
      ...
      <section className="row mb-2">
        <div className="mb-1">
          ...
          <span>
            <Button className="btn-sm btn-icon me-1" onClick={() => groupByTaxable()} data-test="group-by-btn">
              <span>Group by Taxable</span>
            </Button>
            <Button className="btn-sm btn-icon me-1" onClick={() => clearGrouping()} data-test="clear-grouping-btn">
