...
## Multiple Demos of the [Slickgrid-React](https://github.com/slickgrid-universal/slickgrid-react) library

### Installation
Git clone the demo and npm install it, then run and enjoy fully working demo.

```sh
git clone https://github.com/slickgrid-universal/slickgrid-react-demos
